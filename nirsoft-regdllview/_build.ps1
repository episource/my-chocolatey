...
$startTitle = "RegDllView (x64)"
$exeName = "RegDllView.exe"
$zipUrl = "http://www.nirsoft.net/utils/regdllview-x64.zip"

$changelogUrl = "http://www.nirsoft.net/utils/registered_dll_view.html"
