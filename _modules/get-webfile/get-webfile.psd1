...
ModuleVersion = '2018.10.01'

# ID used to uniquely identify this module
GUID = '9544653d-ac56-4b59-9f29-40c58a06f6a5'

# Author of this module
Author = 'Joel Bennet, Bill Barry, Gwen Dallas, Mike Ling, Philipp Serr'
...
Description = 'Save content received by Invoke-WebRequest to a file using ' + `
              'the filename provided in the Content-Disposition header.'
...
FunctionsToExport = @('Get-WebFile', 'Get-VtScan')
