...
RootModule = 'regedit.psm1'

# Version number of this module.
ModuleVersion = '2016.09.01'

# ID used to uniquely identify this module
GUID = '37afcbaa-8ffc-4750-8025-3d335eb498ff'
...
Description = 'A collection of cmdlets for manipulating the windows ' + `
              'registry. The module focuses on importing and exporting ' + `
              'predefined registry images.'
