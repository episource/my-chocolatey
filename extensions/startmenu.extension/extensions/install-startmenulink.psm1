...
.DESCRIPTION
    ...
    links created are recorded for later uninstall. Per default uninstallation
    is done automatically, so there's no need to invoke Uninstall-StartMenuLink
    manually.
...
.PARAMETER NoAutoUninstall
    OPTIONAL - Disable the auto uninstall feature. Uninstall-StartMenuLink must
...
function Install-StartMenuLink {
    ...
    If (-not $NoAutoUninstall) {
        ...
        $uninstallCmd    = "Uninstall-StartMenuLink"
