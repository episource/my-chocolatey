...
RootModule = 'conemu-task.psm1'

# Version number of this module.
ModuleVersion = '2016.09.01'

# ID used to uniquely identify this module
GUID = '83bd548c-31e4-4682-b29b-5ad112b25c5a'
...
Description = 'A collection of cmdlets for managing conemu tasks. Currently ' +
              'only the configuration stored in the windows registry can be ' +
              'modified.'
