...
$startTitle = "AppCrashView"
$exeName = "AppCrashView.exe"
$zipUrl = "http://www.nirsoft.net/utils/appcrashview.zip"

$changelogUrl = "http://www.nirsoft.net/utils/app_crash_view.html"
